...
$sql_products = "SELECT * FROM products WHERE category = 'Clothing'";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3 sidebar">
                ...
                <a href="clothing.php" onclick="filterCategory('clothing')"><div class="p-3 mb-2 bg-secondary text-white">Clothing</div></a>
                    ...
                    <div class="col product-card" data-category="<?php echo $product['category']; ?>">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="clothing.php?add_to_cart=<?php echo $product['id']; ?>" class="btn btn-outline-primary"onclick="showPopup()">Add to Cart</a>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
