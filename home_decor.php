            ...
            <div class="col-md-9">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4" id="productContainer">
                    ...
                    <div class="col product-card" data-category="Home Decor">
                        <div class="card">
                            <img src="images/bu1.jpg" class="card-img-top" alt="Jewelry">
                            <div class="card-body">
                                <h5 class="card-title">Handmade Bucket</h5>
                                <p class="card-text">Beautiful handmade bucket for your exersories</p>
                    ...
                    <div class="col product-card" data-category="Home Decor">
                        <div class="card">
                            <img src="images/bu2.jpg" class="card-img-top" alt="Saree">
                            <div class="card-body">
                                <h5 class="card-title">Traditional Bucket</h5>
                                <p class="card-text">Authentic to embrace your cultural style.</p>
                    ...
                    <div class="col product-card" data-category="Home Decor">
                        <div class="card">
                            <img src="images/bu3.jpg" class="card-img-top" alt="Mehedi">
                            <div class="card-body">
                                <h5 class="card-title">Pure Hanmade bucket</h5>
                                <p class="card-text">Pure for natural coloring.</p>
                    ...
                    <div class="col product-card" data-category="Home Decor">
                        <div class="card">
                            <img src="images/bu4.jpg" class="card-img-top" alt="Tote Bag">
                            <div class="card-body">
                                <h5 class="card-title">Handcrafted Bucket</h5>
                                <p class="card-text">Stylish Your house with craft.</p>
                                <p><strong>450tk</strong></p>
                                <button class="btn btn-outline-primary">Add to Cart</button>
                            </div>
                        </div>
                     ...
                     <div class="col product-card" data-category="Home Decor">
                        <div class="card">
                            <img src="images/hanging.png" class="card-img-top" alt="Tote Bag">
                            <div class="card-body">
