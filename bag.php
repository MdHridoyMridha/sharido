...
$sql_products = "SELECT * FROM products WHERE category = 'Tote Bag'";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3 sidebar">
                ...
                <a href="bag.php" onclick="filterCategory('bags')"><div class="p-3 mb-2 bg-secondary text-white">Tote Bags</div></a>
            </div>
                    ...
                    <div class="col product-card" data-category="<?php echo $product['category']; ?>">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="bag.php?add_to_cart=<?php echo $product['id']; ?>" class="btn btn-outline-primary"onclick="showPopup()">Add to Cart</a>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
